...
<div class="main-header">
    ...
    <p>Tác giả: Trần Thị Hoa - Trường Tiểu học Hùng An - ĐT: 0912091597</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Thị Hoa - Trường  Tiểu học Hùng An - ĐT: 0912091597</div>", unsafe_allow_html=True)
